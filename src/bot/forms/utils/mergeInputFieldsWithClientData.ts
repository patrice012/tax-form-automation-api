...
import { normalizeText } from "./inputMapping";
import { normalizeXPath } from "./normalizeXPath";

export function processMixedInputs(input: InputField, refData: any): IInput[] {
  return (
...
export function processTableInputs(
  input: InputField,
  refData: any[]
): IInput[] {
  return (
...
export function mergeInputFieldsWithClientData(
